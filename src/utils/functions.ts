...
import { Square, Color, Piece } from '../models/types';
...
export function compareInterfaces(interface1: any, interface2: any): boolean {
    return JSON.stringify(interface1) === JSON.stringify(interface2);
}
